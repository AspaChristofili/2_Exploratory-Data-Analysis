plot4 <- function() {
        ## This function will read the household_power_consumption.txt file, will subset for data taken 
        ## from 2 days: 2007-02-01 and 2007-02-02 and will generate 4 plots in 1 space 
        ## (that is, GAP vs time, Vol vs time, submetering vs time and GRP vs time)
